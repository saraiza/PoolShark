...
/**
@brief ArchiveRouter switches between multiple downstream archives

Use this when you want "one of N" switching.
*/
class ArchiveRouter : public Archive
{
public:
	ArchiveRouter();	
	virtual ~ArchiveRouter() override {}

	void AddInner(int iKey, Archive* pAr);
	void SetActive(int iKey);
...
private:
	QDataStream::FloatingPointPrecision m_prec = QDataStream::FloatingPointPrecision::SinglePrecision;
	QMap<int, Archive*> m_mapInners;
	Archive* m_pActive = nullptr;
};
